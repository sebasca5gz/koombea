...
class Template {
    ...
    function SetOptions($options)
    {
        ...
        // vanguard compatibility mode enforces die_0on_bad_params = 0
        ...
        if (func_num_args() == 2) {
            if (is_scalar($value) || empty($value)) {
                ...
                if (isset($this->names[$arg])) {
                    ...
                    trigger_error("Template::AddParam() : Attempt to set value for non existent variable name '".$arg."' - this variable name doesn't match any declarations in the template file <pre>" .print_r($this->options). "</pre>", E_USER_ERROR);
                }
